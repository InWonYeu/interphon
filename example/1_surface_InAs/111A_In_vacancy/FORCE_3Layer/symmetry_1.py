    ...
    for _W_ind, _W_select in enumerate(W_select):
        ...
        for _atom_index, _ in enumerate(unit_cell.atom_true):
            ...
            for _satom_index, value in enumerate(super_cell.atom_true):
                ...
                # _distance = np.dot(_W_select, satom_true_original[:, _satom_index]) - _atom_in_primitive_rot
        ...
        print("_same_supercell_index ({0}): {1}".format(len(_same_supercell_index), _same_supercell_index))
