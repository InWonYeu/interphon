...
# ones.
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.napoleon', 'sphinx.ext.doctest', 'sphinx.ext.githubpages', "sphinx.ext.viewcode", "sphinx.ext.mathjax"]
